...
//           CustomAxios.get(`${baseurl}/${initURL}/rbi-tracking/get-departments`),
//           CustomAxios.get(`${baseurl}/${initURL}/rbi-tracking/get-logs`),
//         ]);
...
const DepartmentDashboard = () => {
  return <div>Department Dashboard Content</div>;
};
