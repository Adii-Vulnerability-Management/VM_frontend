...
function Dashboard() {
  ...
  return (
    <div className="p-2 mx-auto bg-white rounded-lg">
      <h2 className="text-2xl font-bold text-center text-[#2B245C] mb-4">
                ...
                assignedTasks.map((task) => {
                  ...
                  return (
                    <tr key={task._id} className="border-b text-center">
                      ...
                      <td className="py-3 px-6 font-semibold text-[#2B245C]">
                      ...
                      <td className="py-3 px-6 text-center">
                        <button
                          ...
                          className="bg-[#2B245C] text-white px-4 py-2 rounded-md hover:bg-[#2a1250]"
                        >
                          Info
                        </button>
                      </td>
