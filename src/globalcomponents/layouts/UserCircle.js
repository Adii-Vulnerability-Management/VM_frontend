...
//   FiFileText,
// } from "react-icons/fi";
// import { getDecryptedUserData } from "@/utils/auth";
...
//           {
//             id: uuid(),
//             link: "/governance/buisness-management",
...
//   },
// ];
// const SuperAdminDashboardMenu = [
//   // SuperAdmin Menu: Includes GRC features and more comprehensive options
//   {
...
//       {
//         id: uuid(),
//         link: "/superadmindashboard/CompanyStatusDashboard",
//         name: "Average Dashboard",
//         icon: "FiBarChart", // Replace with another icon if needed
//       },
//       // {
//       //   id: uuid(),
//       //   link: "/superadmindashboard/AdminDetailDashboard",
//       //   name: "Detailed Dashboard",
//       //   icon: "FiFileText", // Replace with a more specific icon if desired
//       // },
//     ],
//   },
//   //{
...
//   //     {
//   //       id: uuid(),
//   //       link: "/superadmindashboard/TrustDashboardPage",
//   //       name: "Dashboard",
//   //       icon: "FiUsers",
//   //     },
//   //   ],
//   // },
// ];
// const SuperUserDashboardMenu = [
//   // SuperUser Menu: Dummy menu for now
//   {
//     id: uuid(),
...
//       {
//         id: uuid(),
//         link: "/superusermodule",
//         name: "Create Admin",
//         icon: "FiUser",
//       },
//       {
//         id: uuid(),
//         link: "/superuserportal/AdminDashboard",
//         name: "Framework Assignment",
//         icon: "FiUser",
//       },
//     ],
//   },
...
//   useEffect(() => {
//     setFullUser(getDecryptedUserData());
//   }, []);
...
//   const handleSignOut = async () => {
//     try {
//       await axios.get(`${baseurl}/apiv1/logout`, { withCredentials: true });
//       Cookies.remove("user_data");
//       setUserData(null);
//       router.push("/login");
...
//         setUserData(parsedData); // Store user data
//       } catch (error) {
//         console.error("Error parsing user data:", error);
//       }
//     }
//   }, []);
//   console.log("userData?.role", userData?.user_designation);
//   const currentMenu =
//     userData?.user_designation === "superadmin"
//       ? SuperAdminDashboardMenu
//       : userData?.user_designation === "super_user"
//       ? SuperUserDashboardMenu
//       : AdminDashboardMenu; // Default to SuperUserMenu for other cases
