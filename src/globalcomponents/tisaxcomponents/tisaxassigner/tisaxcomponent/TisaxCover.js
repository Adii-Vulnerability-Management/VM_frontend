  ...
  useEffect(() => {
    ...
    const fetchData = async (id) => {
      try {
        ...
        let defaultValuesResponse = await CustomAxios.get(
          `${baseurl}/${initURL}/assign-tisax-task/assigner-assigned-tasks` // Replace with your actual API endpoint
        );
        // let filterData = defaultValuesResponse.data.find((loc) => loc._id == rootId) || {}

        defaultValuesResponse.data = defaultValuesResponse?.data?.find((l) => l._id == rootId).locationId || {}
