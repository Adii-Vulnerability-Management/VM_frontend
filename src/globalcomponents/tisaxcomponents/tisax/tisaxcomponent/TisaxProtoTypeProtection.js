...
function TisaxProtoTypeProtection(props) {
  ...
  const handleAdditionalRequirementsChange = (
    ...
    setPrototypeProtectionData((prevData) => {
      ...
      const groupData = newData[groupIndex];
      if (!groupData || !groupData.Items) {
        // Handle case when groupData or Items array is not found
        return prevData;
      }
      const itemData = groupData.Items[itemIndex];
      if (!itemData) {
        // Handle case when itemData is not found
        return prevData;
      }
      if (field === "answer") {
        const myData =
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-sm mb-4">
                      ...
                      <div className="p-2 bg-white rounded-lg shadow-lg">
                        ...
                        <div className="mt-4 p-6 bg-gray-100 rounded-lg shadow-inner">
                          ...
                          {selectedTab === "Additional Requirements" && (
