...
export default function RiskAnalysisType2() {
    return (
        <div className="space-y-8 p-6 bg-white rounded-xl shadow-lg">
            ...
            <div className="p-4 border rounded-lg bg-gray-50 space-y-4">
                <div className="flex items-center space-x-2">
                    <span role="img" aria-label="step-2" className="text-2xl">2️⃣</span>
                    <h3 className="text-lg font-bold text-gray-700">Step 2: Assess Risk Management and Control Processes</h3>
                </div>
                <p className="text-gray-600">
                    In this second step, we evaluate the design and adequacy of risk management and control processes.
                    As illustrated below, each audit area&apos;s design may be classified as <strong>Adequate</strong>,
                    <strong>Needs Improvement</strong>, or <strong>Inadequate</strong> based on specific criteria.
                </p>
                ...
                <div className="overflow-x-auto border rounded-lg">
                    <table className="min-w-full text-sm divide-y divide-gray-200">
                        <thead className="bg-gray-200">
                            <tr>
                                <th className="px-4 py-2 border-b text-left font-medium text-gray-700">Assessment of Design</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-100">
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-2 border-b">
                                    <ul className="list-disc list-inside space-y-1">
                                        <li>Risk management, control, and governance processes are operating effectively.</li>
                                        <li>Risk ownership is clearly defined and active.</li>
                                        <li>Management and/or auditors proactively identify improvements or issues.</li>
                                        <li>The organization is engaged in risk identification and mitigation.</li>
                                    </ul>
                                </td>
                            </tr>
                            {/* Needs Improvement */}
                            <tr>
                                <td className="px-4 py-2 border-b">Needs Improvement</td>
                                <td className="px-4 py-2 border-b">
                                    <ul className="list-disc list-inside space-y-1">
                                        <li>Some risk management and control processes are operating effectively, but many are not documented or do not exist.</li>
                                        <li>Most key risks are mitigated to an acceptable level.</li>
                                        <li>Some risks exist but not all have owners.</li>
                                    </ul>
                                </td>
                            </tr>
                            {/* Inadequate */}
                            <tr>
                                ...
                                <td className="px-4 py-2 border-b">
                                    <ul className="list-disc list-inside space-y-1">
                                        <li>Risk management and control processes are poorly designed, inconsistently executed, or do not exist.</li>
                                        <li>Risk information is not documented, and risks are not remediated fully.</li>
                                        <li>Risk management is reactive.</li>
                                    </ul>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div className="p-4 border rounded-lg bg-gray-50 space-y-4">
                <div className="flex items-center space-x-2">
                    <span role="img" aria-label="step-4" className="text-2xl">4️⃣</span>
                    <h3 className="text-lg font-bold text-gray-700">Step 4: Likelihood Ratings</h3>
                </div>
                <p className="text-gray-600">
