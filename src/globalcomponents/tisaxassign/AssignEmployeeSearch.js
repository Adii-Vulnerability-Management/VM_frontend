    ...
    <div>
      ...
      <div className="flex justify-end mt-4">
        <button
          ...
          className="px-6 py-3 min-w-20 flex justify-center items-center bg-[#3F2073] text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition"
        >
